...
import {
  ...
  wt,
  yu
} from "./chunk-5K3X77AU.js";
import {
  z
} from "./chunk-BZALINTM.js";
import {
  gt,
  yn
} from "./chunk-A5QAOOHT.js";
import {
  require_react
...
// node_modules/.pnpm/@storybook+blocks@8.6.12_react-dom@18.3.1_react@18.3.1__react@18.3.1_storybook@8.6.12_prettier@2.8.8_/node_modules/@storybook/blocks/dist/index.mjs
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source: source2, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = globalThis, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./components-55H362KI.js");
...
var BooleanControl = ({ name: name2, value: value3, onChange, onBlur, onFocus, argType }) => {
  ...
  if (value3 === void 0)
    return import_react.default.createElement(Na, { variant: "outline", size: "medium", id: getControlSetterButtonId(name2), onClick: onSetFalse, disabled: readonly }, "Set boolean");
...
var ObjectControl = ({ name: name2, value: value3, onChange, argType }) => {
  ...
  if ((0, import_react.useEffect)(() => {
    ...
    return import_react.default.createElement(Na, { disabled: readonly, id: getControlSetterButtonId(name2), onClick: onForceVisible }, "Set object");
...
var TextControl = ({ name: name2, value: value3, onChange, onFocus, onBlur, maxLength, argType }) => {
  ...
  if (value3 === void 0)
    return import_react.default.createElement(Na, { variant: "outline", size: "medium", disabled: readonly, id: getControlSetterButtonId(name2), onClick: onForceVisible }, "Set string");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-YHDXOIA2-NEZ53AT4.js"));
...
var CodeOrSourceMdx = ({ className, children, ...rest }) => {
  if (typeof className != "string" && (typeof children != "string" || !children.match(/[\n\r]/g)))
    return import_react.default.createElement(gu, null, children);
...
var Heading2 = ({ children, disableAnchor, ...props }) => {
  if (disableAnchor || typeof children != "string")
    return import_react.default.createElement(yu, null, children);
...
//# sourceMappingURL=chunk-O55Z5EIK.js.map
