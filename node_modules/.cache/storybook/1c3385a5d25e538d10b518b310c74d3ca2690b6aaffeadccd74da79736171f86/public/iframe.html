    ...
    console.warn('unable to connect to top frame for connecting dev tools');
      ...
      #storybook-docs[hidden] {
        display: none !important;
            ...
            window['STORIES'] = [{"titlePrefix":"","directory":"./src/Components","files":"**/*.mdx","importPathMatcher":"^\\.[\\\\/](?:src\\/Components(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\.mdx)$"},{"titlePrefix":"","directory":"./src/Components","files":"**/*.stories.@(js|jsx|ts|tsx|mjs)","importPathMatcher":"^\\.[\\\\/](?:src\\/Components(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\.stories\\.(js|jsx|ts|tsx|mjs))$"}];
      ...
      import './vendors-node_modules_storybook_addon-docs_dist_preview_mjs-node_modules_storybook_addon-essen-1f7055.iframe.bundle.js';
